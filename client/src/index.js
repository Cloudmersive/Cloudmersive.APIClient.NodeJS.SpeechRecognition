...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SpeechRecognitionResult', 'model/TextToSpeechRequest', 'api/RecognizeApi', 'api/SpeakApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/SpeechRecognitionResult'), require('./model/TextToSpeechRequest'), require('./api/RecognizeApi'), require('./api/SpeakApi'));
  }
}(function(ApiClient, SpeechRecognitionResult, TextToSpeechRequest, RecognizeApi, SpeakApi) {
  'use strict';
  ...
  var exports = {
    ...
    /**
     * The TextToSpeechRequest model constructor.
     * @property {module:model/TextToSpeechRequest}
     */
